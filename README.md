...
- Added quant bootstrap sampling with pure Rust kallisto-style H5 output, upstream-readable HDF5
  metadata, kallisto-compatible default bias datasets, and optional plaintext
  `bs_abundance_*.tsv` files.
